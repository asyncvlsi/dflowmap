...
void ChpCircuitGenerator::printSplitChp(const char *instance,
...
void ChpCircuitGenerator::printArbiterChp(const char *instance,
                                          const char *outName,
                                          const char *coutName,
                                          unsigned dataBW,
                                          CharPtrVec &inNameVec) {
...
void ChpCircuitGenerator::printMixerChp(const char *instance,
                                        const char *outName,
                                        const char *coutName,
                                        unsigned dataBW,
                                        CharPtrVec &inNameVec) {
